...
import 'package:school_management/presentation/staff/contents/accruals/accruals_layout.dart';
import 'package:school_management/presentation/staff/contents/accruals/dialog/show_accrual_create_dialog.dart';
import 'package:school_management/presentation/staff/custom_date_field.dart';

class AccrualsContent extends StatelessWidget {
  static const label = "Начисления";

  const AccrualsContent({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          AddButton(
            onTap: () {
              showAccrualCreateDialog(context);
            },
          ),
          const SizedBox(height: 62),
