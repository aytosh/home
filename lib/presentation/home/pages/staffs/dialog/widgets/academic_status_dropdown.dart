...
class AcademicStatusDropdown extends StatefulWidget {
  final Function(String)? onChanged;

  const AcademicStatusDropdown({super.key, this.onChanged});

  @override
  createState() => _AcademicStatusDropdownState();
}

class _AcademicStatusDropdownState extends State<AcademicStatusDropdown> {
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              onTap: () {
                                academicStatus = "Работает";
                                widget.onChanged?.call("Working");
                                _toggleDropdown(close: true);
                              },
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        SizedBox(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              onTap: () {
                                academicStatus = "Уволен";
                                widget.onChanged?.call("Fired");
                                _toggleDropdown(close: true);
                              },
                              child: Row(
                                children: [
